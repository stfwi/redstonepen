...
public class StandardBlocks
{
  ...
  public static class Directed extends BaseBlock implements IStandardBlock
  {
    ...
    public Directed(long config, Block.Properties properties, final Function<List<BlockState>, Map<BlockState,VoxelShape>> shape_supplier)
    {
      super(config, properties);
      setDefaultState(stateContainer.getBaseState().with(FACING, Direction.UP));
      vshapes = shape_supplier.apply(getStateContainer().getValidStates());
    }
    ...
    public Directed(long config, Block.Properties properties, final AxisAlignedBB[] unrotatedAABBs)
    {
      this(config, properties, (states)->{
        ...
        for(BlockState state:states) {
          vshapes.put(state, Auxiliaries.getUnionShape(Auxiliaries.getRotatedAABB(unrotatedAABBs, state.get(FACING), is_horizontal)));
        }
        return vshapes;
      });
    }
  ...
  public static class Horizontal extends BaseBlock implements IStandardBlock
  {
    ...
    public Horizontal(long config, Block.Properties properties, final Function<List<BlockState>, Map<BlockState,VoxelShape>> shape_supplier)
    {
    ...
    public Horizontal(long config, Block.Properties properties, final AxisAlignedBB[] unrotatedAABBs)
    {
      this(config, properties, (states)->{
        Map<BlockState,VoxelShape> vshapes = new HashMap<>();
        for(BlockState state:states) {
          vshapes.put(state, Auxiliaries.getUnionShape(Auxiliaries.getRotatedAABB(unrotatedAABBs, state.get(HORIZONTAL_FACING), true)));
        }
        return vshapes;
      });
    }
  ...
  public static class DirectedWaterLoggable extends Directed implements IWaterLoggable, IStandardBlock
  {
    ...
    public DirectedWaterLoggable(long config, Block.Properties properties, final Function<List<BlockState>, Map<BlockState,VoxelShape>> shape_supplier)
  ...
  public static class HorizontalWaterLoggable extends Horizontal implements IWaterLoggable, IStandardBlock
  {
    ...
    public HorizontalWaterLoggable(long config, Block.Properties properties, final Function<List<BlockState>, Map<BlockState,VoxelShape>> shape_supplier)
