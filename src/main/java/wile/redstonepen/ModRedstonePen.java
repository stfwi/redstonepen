...
public class ModRedstonePen
{
  ...
  public static final CreativeModeTab CREATIVE_MODE_TAB = (new CreativeModeTab("tab" + ModConstants.MODID) {
    public ItemStack makeIcon() { return new ItemStack(Registries.getItem("quill")); }
  });
